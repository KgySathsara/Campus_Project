...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets\css\styleone.css') }}">
  <title>Schedule Template | CodyHouse</title>
</head>
<body>
  <header class="cd-main-header text-center flex flex-column flex-center">

    <h1 class="text-xl">Events Schedule Template</h1>
  </header>
  ...
  <script src="{{ asset('assets\js\utilone.js') }}"></script> <!-- util functions included in the CodyHouse framework -->
  <script src="{{ asset('assets\js\mainone.js') }}"></script>
